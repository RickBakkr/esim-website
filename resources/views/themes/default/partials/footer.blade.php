    ...
    <div class="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        <div class="sm:flex justify-between sm:items-center mb-10">
            ...
            <nav class="flex space-x-6 text-sm/6 mt-12 sm:mt-0" aria-label="Footer">
                ...
                <a href="{{ getRoute('destinations') }}" class="text-gray-600 hover:text-gray-900">{{ trans('navigation.destinations') }}</a>
                <a href="{{ getRoute('about') }}" class="text-gray-600 hover:text-gray-900">{{ trans('navigation.about') }}</a>
            </nav>
            <div class="text-sm/6 text-gray-600">
{{--                <p>Need help? <a href="mailto:support@example.com" class="text-blue-600 hover:text-blue-800">Contact--}}
{{--                        Us</a></p>--}}
                &nbsp;
            </div>
        </div>
        ...
        <div class="sm:flex justify-between items-center pt-12">
            <p class="text-sm/6 text-gray-600">
                &copy; {{ date('Y') }} {{ config('app.name') }}. {{ trans('footer.all_rights_reserved') }} <br/>
                {{ trans('footer.foreign_currencies_for_reference_only') }}
            </p>
